...
\label{tab:combat-modifiers} \label{tab:combat-modifiers} \end{table} 
...
Running	&DV x 2	\\ \hline

Chase Speeds	&DV x (velocity $\hline$ 10)	\\ \hline
...
\begin{table} \begin{tabular}{|l|l|p{45mm}|l|l|} \hline
...
\label{tab:improvised-weapons} \label{tab:improvised-weapons} \end{table} 
...
\begin{table} \begin{tabular}{|p{8cm}|r|r|r|} \hline
...
\label{tab:sample-objects-structures} \label{tab:sample-objects-structures} \end{table} 
...
Blades &To SOM $\div$ 5 &To SOM $\div$ 2 &To SOM &To SOM x 2 \\ \hline
...
\begin{table} \begin{tabular}{|p{8cm}|r|r|} \hline
...
\label{tab:healing} \label{tab:healing} \end{table} 
...
\label{tab:stressful-experiences} \label{tab:stressful-experiences} \end{table} 
